...
/** @type {string} */
const CACHE_VERSION = '1777963760|169421444975';
/** @type {string} */
const CACHE_PREFIX = 'bossfight-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'bossfight.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["bossfight.html","bossfight.js","bossfight.offline.html","bossfight.icon.png","bossfight.apple-touch-icon.png","bossfight.audio.worklet.js","bossfight.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["bossfight.wasm","bossfight.pck"];
